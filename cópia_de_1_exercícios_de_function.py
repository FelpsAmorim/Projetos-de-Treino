# -*- coding: utf-8 -*-
"""Cópia de 1_Exercícios_de_Function.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1LE76iVUGO1N-yh3bHjlu1JcIjyqeTz1Q
...
carga_tributaria = carga(preco, custo, lucro)
print(f"A carga tributária sobre o produto é de {carga_tributaria:.2f}%")
