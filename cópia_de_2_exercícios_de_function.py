# -*- coding: utf-8 -*-
"""Cópia de 2_Exercícios_de_Function.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/13AQ1wpBfveVfU8_WlCw4dt4pY58m-5w1
...
def calcular_stockout(vendas):
  vendas_perdidas_por_estoque = 0
  vendas_concluidas = 0

  for venda in vendas.values():
    valor_venda, status, motivo = venda
    if status == "Cancelado" and motivo == "Estoque em Falta":
      vendas_perdidas_por_estoque += valor_venda
    elif status == "Concluído":
      vendas_concluidas += valor_venda

  if vendas_concluidas == 0:
    return 0

  return (vendas_perdidas_por_estoque / (vendas_concluidas + vendas_perdidas_por_estoque)) * 10

#rode sua function aqui com o dicionário dado para ver se ela está funcionando

stockout = calcular_stockout(vendas)
print(f"Percentual de Stockout: {stockout:.2f}%")
...
def descobrir_inadimplentes(clientes_devedores):
  ...
  for cliente in clientes_devedores:
    cpf, valor_devido, qtde_dias = cliente

    if valor_devido > 1000 and qtde_dias > 20:
